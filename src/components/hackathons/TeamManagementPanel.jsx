            ...
            {members.length === 0 ? (
                ...
                <div className="space-y-3">
                    {members.map((member) => (
                        <div
                            key={member.id}
                            className="flex items-center justify-between bg-white/5 rounded-lg p-4 border border-white/5 hover:border-white/10 transition-colors"
                        >
                                    ...
                                    {editingMemberId === member.id ? (
                                        <div className="flex items-center gap-2 mt-1">
                                            <input
                                                ...
                                                className="px-2 py-1 text-xs bg-white/10 border border-white/20 rounded text-gray-300 focus:outline-none focus:ring-1 focus:ring-purple-500"
                                                placeholder="Role"
                                                autoFocus
                                            />
                                            <button
