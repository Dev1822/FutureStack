    ...
    return (
        <div className="bg-[#0A0A0A] rounded-xl p-6 border border-white/10">
            ...
            <textarea
                ...
                className="w-full h-64 bg-white/5 border border-white/10 rounded-lg p-4 text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
            />
